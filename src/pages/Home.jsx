                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center justify-center gap-2">
                          <Link to={`/user/${user.email}`}>
                            <button className="cursor-pointer bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700">
                              View
                            </button>
                          </Link>

                          <button className="cursor-pointer bg-yellow-500 text-white px-4 py-2 rounded-lg hover:bg-yellow-600">
                            Update
                          </button>

                          <button className="cursor-pointer bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700">
                            Delete
                          </button>
                        </div>
                      </td>
